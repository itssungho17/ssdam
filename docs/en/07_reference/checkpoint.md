...
**Checkpoint** is a **PASS / FAIL judgment mechanism** performed at Stage termination.

In SSDAM, Checkpoint is not simply confirming completion but:

> **"A decision point that authorizes or denies state transition (State Transition)"**
...
|------|------|------|
| **PASS** | Stage objective met | Next Stage progression |
...
## 8. Policy-Governed Judgment (Policy-Governed)
...
## 11. Traceability Requirements (Traceability)
