...
performed within a Stage to achieve its purpose.
...
|------|------|
| Objective Alignment | Directly connected to Stage goals |
...
1. **Purpose Orientation**
   - Must be directly connected to Stage goals
...
Execution termination ≠ Stage termination
